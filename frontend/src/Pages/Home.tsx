        ...
        <>
            <section id="homePage">
                ...
                <div className="tutorialFrame">
                    ...
                    <img src="./src/assets/custom-question.png" alt="custom quizlet question" />
                </div>
                <div className="tutorialFrame">
                    ...
                    <img src="./src/assets/custom-quiz.png" alt="custom quizlet" />
                </div>
                <div className="tutorialFrame">
                    ...
                    <img src="./src/assets/link-code.png" alt="unique quiz link and code" />
                </div>
                <div className="tutorialFrame">
                    ...
                    <img src="./src/assets/controlled-quiz.png" alt="quiz in progress" />
                </div>
                <div className="tutorialFrame">
                    ...
                    <img src="./src/assets/grade-results.png" alt="quiz admin screen" />
                </div>
                <button
